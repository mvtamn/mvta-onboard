...
const scoped = { scoped: true, snapshotsResolver: true, penaltyScaling: true, snapshotsSeverity: true, windowModes: true, categorised: true, rulesLock: true };
const unscoped = { scoped: false, snapshotsResolver: false, penaltyScaling: false, snapshotsSeverity: false, windowModes: false, categorised: false, rulesLock: false };
