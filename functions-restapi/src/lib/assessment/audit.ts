...
export const AUDIT_ACTIONS = ["computed", "reviewed", "validation_shared", "finalized", "draft_generated", "issuance_proof_prepared", "issuance_proof_voided", "issued", "reopened", "correction_started", "stale_due_to_prior_period_reopen", "exception_authorized", "evidence_added", "dispute_filed", "dispute_decided"] as const;
export type AuditAction = typeof AUDIT_ACTIONS[number];
export type AuditEntity = "period" | "assessment" | "report" | "dispute";
