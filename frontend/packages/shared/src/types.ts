...
export interface DepotDepartureTest { id: string; location_id: string; location_name: string; geofence_id: string; geofence_name: string; is_enabled: boolean; expires_at: string; created_by: string | null; created_at: string; updated_by: string | null; updated_at: string; last_message_status: "pending" | "sent" | "failed" | "expired" | null; last_message_at: string | null; }
