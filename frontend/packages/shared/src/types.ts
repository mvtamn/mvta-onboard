...
export interface EventServicePlan { id: string; name: string; status: "draft" | "review" | "approved" | "active" | "completed" | "suspended"; start_date: string | null; end_date: string | null; created_by: string; created_at: string; updated_by: string | null; updated_at: string; links?: { kind: "routes" | "geofences" | "locations"; service_plan_id: string; value: string | number }[]; }
