...
import { Admin, DetourReasonCodesSection, EventMonitoringSettingsSection, RouteClassificationSection } from "./Admin.js";
...
export function AdminServiceConfiguration() { return <><Admin /><DetourReasonCodesSection /></>; }
