...
vi.mock("../../../context/FixedRouteRefreshContext.js", () => ({
  useFixedRouteRefresh: () => ({ lastCompletedAt: null, secondsLeft: 30, intervalMs: 30_000, arrivalClock: { lastArrivalAt: Date.now() - 60_000, slotStartAt: Math.floor((Date.now() - 60_000) / 300_000) * 300_000, cadenceMs: 300_000 }, history: [true, true] }),
