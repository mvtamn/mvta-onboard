...
export function EventResourceMapEditor() {
  ...
  return <>
    ...
    <div className="panel-body event-direction-rules">
      <p className="panel-desc">A direction rule turns one geofence crossing into an operational message. Configure the boundary, movement, and response in that order. Lower priority wins when rules overlap.</p>
