// Minimal line-style icons for the sidebar nav. Kept as plain inline SVG
// (no icon library dependency) so the CSP's default-src stays untouched.
type IconProps = { };
...
export function IconDashboard(_: IconProps) {
  return (
    <svg {...base}>
...
export function IconCompose(_: IconProps) {
  return (
    <svg {...base}>
      <path d="M12 20h9" />
...
export function IconMessages(_: IconProps) {
  return (
    <svg {...base}>
...
export function IconBell(_: IconProps) {
  return (
    <svg {...base}>
...
export function IconUsers(_: IconProps) {
  return (
    <svg {...base}>
...
export function IconClock(_: IconProps) {
  return (
    <svg {...base}>
...
export function IconGear(_: IconProps) {
  return (
    <svg {...base}>
...
export function IconWrench(_: IconProps) {
  return (
    <svg {...base}>
      <path d="M14.7 6.3a4 4 0 0 0-5.6 5.6L2 19l3 3 7.1-7.1a4 4 0 0 0 5.6-5.6l-2.8 2.8-2.1-2.1Z" />
    </svg>
  );
}
...
export function IconMoon(_: IconProps) {
  return (
    <svg {...base}>
