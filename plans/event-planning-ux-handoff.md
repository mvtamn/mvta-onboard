...
- Saved project-owner convention: bump `frontend/packages/onboard-console/package.json`'s version + add a `CHANGELOG.md` entry with every user-facing change to that package. Current version: `1.5.26`.
