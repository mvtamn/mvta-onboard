...
**Built:** September 9, 2026, from `ContractorPerformanceAssessment_Functions_Evaluation.md` (findings, delivery order) and `ContractorPerformanceAssessment_Design.md` §0 (what was designed, what was built, what remains). Those two are the sources; this file is the work breakdown. When they disagree, fix them, not this.
...
### A1 — The Escalation Streak reads one issued outcome per Agreement-month · **M**
...
### A2 — A Shared Validation Draft shows the recommended amounts and binds to their hash · **M**
...
### A3 — Assessment Exception writes are guarded and restart sharing · **S**
...
### A4 — Registered evidence is sealed · **M**
...
### A5 — The report separates computation from the binding adjustment · **S**
...
### B1 — One cancellable loader for the selected period · **S**
...
### B2 — Ranged penalties expose amount entry · **S**
...
### B3 — Review shows recommendations before binding · **S**
...
### B4 — The Report page opens the artifact it manages · **M**
...
### Gate — dev walkthrough · **S, a person**
...
### C1 — Every governance act writes an audit row · **M**
...
### C2 — `GET /api/compliance-assessment-audit` and a History panel · **M**
...
### D1 — Occurrence, exclusion, exception, and CAP schedules · **M**
...
### E1 — CAP transitions and due dates · **M**
...
### G1 — Lifecycle and concurrency contract tests · **L**
